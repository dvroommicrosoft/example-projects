 ...
 * @param {string[]} [options.types] - Restrict the report to these event types.
 *   Unrecognized entries and entries whose type isn't in this list are
 *   excluded from both totals and buckets.
 */
