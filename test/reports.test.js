...
describe("buildReport", () => {
  ...
  test("filters entries by the provided types option", () => {
    const entries = [
      { itemId: "1", title: "a", type: "created", at: "2026-01-01T00:00:00.000Z" },
      { itemId: "1", title: "a", type: "completed", at: "2026-01-01T01:00:00.000Z" },
      { itemId: "2", title: "b", type: "deleted", at: "2026-01-02T00:00:00.000Z" },
    ];
    const report = buildReport(entries, { types: ["completed", "deleted"] });
    assert.deepEqual(report.totals, { created: 0, completed: 1, reopened: 0, deleted: 1 });
    assert.deepEqual(report.buckets, [
      { date: "2026-01-01", created: 0, completed: 1, reopened: 0, deleted: 0 },
      { date: "2026-01-02", created: 0, completed: 0, reopened: 0, deleted: 1 },
    ]);
  });
});
